<template>
  <a-card :bordered="false">
    ...
    <c-page-edit v-if="['edit','editing'].includes(PageView)"
                 ...
                 :beforeRecordChange="beforeRecordChange" :onRecordChange="onRecordChange" :loading="loading"
                 v-model="selectedRow" :disabled="PageView==='edit'"></c-page-edit>
    <auth v-model="visible" :id-duty="selectedRow._id"></auth>
  </a-card>
</template>
...
import Auth from "@/views/base/duty/auth";
